...
public class ShulkerpackScreenHandler extends GenericContainerScreenHandler
{
    ...
    public ShulkerpackScreenHandler(int syncId, PlayerInventory playerInventory)
    {
        this(syncId, playerInventory, new SimpleInventory(27));
    }

    public ShulkerpackScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory)
    {
        this(Backpack.BACKPACK_SCREEN_HANDLER, syncId, playerInventory, inventory);
    }

    public ShulkerpackScreenHandler(ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, Inventory inventory)
    {
