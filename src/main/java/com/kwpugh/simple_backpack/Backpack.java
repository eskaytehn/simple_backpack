...
import com.kwpugh.simple_backpack.shulkerpack.ShulkerpackItem;
import com.kwpugh.simple_backpack.shulkerpack.ShulkerpackScreenHandler;
...
public class Backpack implements ModInitializer
{
    ...
    public static ScreenHandlerType<ShulkerpackScreenHandler> SHULKER_PACK_SCREEN_HANDLER;
    ...
    public static final Item SHULKER_PACK = new ShulkerpackItem(new Item.Settings().maxCount(1));
    ...
    public void onInitialize()
    {
        ...
        SHULKER_PACK_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, createID("shulker_pack"), new ScreenHandlerType<>(ShulkerpackScreenHandler::new, FeatureFlags.VANILLA_FEATURES));
        ...
        Registry.register(Registries.ITEM, createID("shulker_pack"), SHULKER_PACK);
